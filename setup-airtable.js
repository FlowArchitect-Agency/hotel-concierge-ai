...
const tables = [
  ...
  },
  {
    name: 'Reservations',
    fields: [
      field('ReservationID', 'autoNumber'),
      field('GuestName', 'singleLineText'),
      field('Email', 'email'),
      field('Phone', 'phoneNumber'),
      field('ServiceName', 'singleLineText'),
      { name: 'ServiceType', ...select(['spa', 'restaurant', 'tour', 'transport', 'experience', 'other']) },
      field('PreferredDate', 'date', { dateFormat: { name: 'iso', format: 'YYYY-MM-DD' } }),
      field('PreferredTime', 'singleLineText'),
